...
private const val TAG = "VideoCutTimeBuilder"


class VideoCutTimeBuilder : LifecycleEventObserver {
    ...
    suspend fun cut() = suspendCoroutine { coroutineContext ->
        ...
        session =
            FFmpegKit.executeWithArgumentsAsync(mutableListOf<String>().apply {
                ...
                if (videoinfo?.videoCodecName!="h264")
                {
    ...
    suspend fun init(block: VideoCutTimeBuilder.() -> Unit): VideoCutTimeBuilder {
